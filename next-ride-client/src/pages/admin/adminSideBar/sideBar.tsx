    ...
    >
      <div className="flex flex-col gap-3">
        ...
        <div className="mt-10  flex gap-5 p-2 relative">
          <Image src={dashboardIcon} width={30} height={30} alt="loading" />
        ...
        >
          <Image src={UserIcon} width={30} height={30} alt="loading" />
          {isOpen && display ? (
            <h1 className="text-lg font-semibold text-white">Users</h1>
          ) : null}
        </div>
        <div className=" p-2 flex gap-5">
          <Image src={BikesIcon} width={30} height={30} alt="loading" />
          {isOpen && display ? (
            <h1 className="text-lg font-semibold text-white">Bikes</h1>
          ) : null}
        </div>
        <div className=" p-2 flex gap-5">
          <Image src={Providersicon} width={30} height={30} alt="loading" />
          {isOpen && display ? (
      ...
      <div >
        ...
        <div onClick={adminLogout} className="flex gap-2 items-center hover:bg-[#6A42AB] rounded-lg ">
